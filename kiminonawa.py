...
def NamaeMovie():
    ...
    line = Label(frame_header, text="Kimi no Na wa", bg="#1FBB28", fg="white")
    ...
    movie_image = Image.open("kimi-no-na-wa.jpg")
    ...
    lbl3 = Label(frame_body,
                 text="Two teenagers share a profound, magical connection upon discovering they are swapping\n"
                      "bodies. Things manage to become even more complicated when the boy and girl decide to\n"
                      "meet in person.", justify="center", bg="black", fg="white")
    lbl3.grid(row=3, column=0, columnspan=2, sticky="s", ipady=10, padx=25)

    lbl4 = Label(frame_body, text="Alternative Title: Your Name\n\n"
